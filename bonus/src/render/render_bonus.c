...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/05 15:37:32 by tpandya           #+#    #+#             */
/*   Updated: 2026/01/05 15:37:33 by tpandya          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
* From col=0 (LEFT edge FOV) to col=799 (RIGHT edge FOV),
* shoots ray FROM player, finds distance to wall,
* draws textured column, next ray
*/
